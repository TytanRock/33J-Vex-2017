...
#pragma config(Motor,  port3,           leftFourBar,   tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port6,           mobileGoal1,   tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           mobileGoal2,   tmotorVex393_MC29, openLoop)
...
///////////////////////////////////////////////////////////
	...
	createPositionalGearbox(mobileArm, mobile, 0, 0, 0);
...
///////////////////////////////////////////////////////////
	...
	while(1)
	{
		...
		mobileAngle = convertAngle(SensorValue[mobileGoal], 0, 0);
		...
		increaseConeCount = (bool)vexRT[Btn5U];
		decreaseConeCount = (bool)vexRT[Btn6D];
		mobileUp = (bool)vexRT[Btn8DXmtr2];
		mobileDown = (bool)vexRT[Btn8UXmtr2];
